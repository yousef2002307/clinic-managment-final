...
<link rel="stylesheet" href="{{asset('login-clinic.css')}}">
...
<link rel="stylesheet" href="{{asset('wlCarousel2-2.3.4\docs\assets\owlcarousel\assets\owl.carousel.min.css')}}">
...
@yield('script')
    ...
    <script src="{{asset('jquery-3.7.1.min.js')}}">
    </script>
    <script src="{{asset('bootstrap.bundle.js')}}" defer></script>
